...
<title>Selbsthilfeforum der blz.borderliner.ch &bull; Häufig gestellte Fragen</title>
<!--
...
<div id="page-header" class="nav-block gradient menu-1">
    ...
    <p>Um alle Foren sehen zu können musst Du Dich registrieren. Bitte lies die Ankündigungen der Admins, die &quot;Grundlageninfos&quot; und stell Dich vor, bevor Du aktiv wirst. Einen hilfreichen Gedankenaustausch wünscht Dir das Team der blz.borderliner.ch</p>
</div>
...
<div class="block" id="faqlinks">
	...
	<div class="block">
        <h2>Registrierung und Anmeldung</h2>
            ...
            <dl class="faq">
                <dt id="f0r0">Warum kann ich mich nicht anmelden?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r1">Wozu muss ich mich überhaupt registrieren?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r2">Warum werde ich automatisch abgemeldet?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r3">Wie kann ich verhindern, dass mein Benutzername in der Online-Liste auftaucht?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r4">Ich habe mein Passwort vergessen!</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r5">Ich habe mich registriert, kann mich aber nicht anmelden!</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r6">Ich habe mich vor einiger Zeit registriert, kann mich aber nicht mehr anmelden?!</dt>
                <dd>Es kann sein, dass ein Administrator dein Benutzerkonto aus verschieden Gründen deaktiviert oder gelöscht hat. Außerdem löschen viele Boards regelmäßig Benutzer, die für längere Zeit keine Beiträge geschrieben haben, um die Datenbankgröße zu verringern. Registriere dich einfach erneut und nimm aktiv an den Diskussionen teil!</dd>
                <dd><a href="#faqlinks" class="top2">Nach oben</a></dd>
            </dl>
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r7">Was ist COPPA?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r8">Warum kann ich mich nicht registrieren?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f0r9">Wozu ist die „Alle Cookies des Boards löschen“-Funktion?</dt>
	...
	<div class="block">
        <h2>Benutzerpräferenzen und -einstellungen</h2>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f1r1">Die Forenuhr geht falsch!</dt>
                <dd>Möglicherweise entspricht die angezeigte Zeit nicht deiner eigenen Zeitzone. In diesem Fall solltest du im „Persönlichen Bereich“ die für dich passende Zeitzone (Mitteleuropäische Zeit, ...) festlegen. Die Zeitzone kann dabei nur von registrierten Benutzern geändert werden. Wenn du noch nicht registriert bist, ist dies ein guter Grund, dies jetzt zu tun.</dd>
                <dd><a href="#faqlinks" class="top2">Nach oben</a></dd>
            </dl>
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f1r2">Ich habe die Zeitzone eingestellt, aber die Forenuhr geht immer noch falsch!</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f1r3">Meine Sprache steht auf diesem Board nicht zur Auswahl!</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f1r4">Wie kann ich ein Bild bei meinem Benutzernamen anzeigen?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f1r5">Was ist mein Rang und wie kann ich ihn ändern?</dt>
                <dd>Ränge, die unter deinem Benutzernamen stehen, zeigen an, wie viele Beiträge du bislang erstellt hast oder identifizieren bestimmte Benutzer wie Moderatoren und Administratoren. Normalerweise kannst du den Wortlaut eines Ranges nicht direkt ändern, da sie von der Board-Administration festgelegt wurden. Bitte schreibe keine sinnlosen Beiträge, nur um deinen Rang zu erhöhen — die meisten Boards dulden dieses Verhalten nicht und ein Moderator oder Administrator wird deinen Rang unter Umständen einfach wieder zurücksetzen.</dd>
                <dd><a href="#faqlinks" class="top2">Nach oben</a></dd>
            </dl>
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f1r6">Wenn ich bei einem Benutzer auf den E-Mail-Link klicke, werde ich aufgefordert, mich anzumelden.</dt>
	...
	<div class="block">
        <h2>Beiträge schreiben</h2>
            ...
            <dl class="faq">
                <dt id="f2r0">Wie schreibe ich ein Thema?</dt>
	...
	<div class="block">
        <h2>Textformatierung und Thementypen</h2>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f3r2">Was sind Smilies?</dt>
	...
	<div class="block">
        <h2>Benachrichtigungen und Lesezeichen</h2>
            ...
            <dl class="faq">
                <dt id="f8r0">Was ist der Unterschied zwischen einem Lesezeichen und der Beobachtung eines Themas oder Forums?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f8r1">Wie kann ich ein Forum oder ein Thema beobachten?</dt>
            ...
            <hr class="dashed" />
            <dl class="faq">
                <dt id="f8r2">Wie deaktiviere ich meine Benachrichtigungen?</dt>
    ...
    <ul id="page-footer-menu">
        <li><a href="javascript:void(0);" class="menu-link main"><span>Foren-Übersicht</span></a>
            <ul class="sub">
    			...
    			<li><span>Alle Zeiten sind UTC </span></li>
            </ul>
        </li>
